...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://hyrumadams.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post",
        }
    ...
    UNSAFE_componentWillMount() {
        if (this.props.editMode) {
            this.setState({
                ...
                apiUrl: `https://hyrumadams.devcamp.space/portfolio/portfolio_blogs/${this.props.blogToEdit.id}`,
                apiAction: "patch",
            })
        }
    }
    ...
    handleSubmit(event) {
        axios({
            ...
            if (this.props.editMode) {
                console.log(response.data.portfolio_blog);
